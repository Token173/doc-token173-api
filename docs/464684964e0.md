                ...
                data:
                  - is_image_safe: true
                    prompt: >-
                      ...
                      shoreline. In the distance, there is an island or landmass
                    ...
                    style_type: null
                    url: >-
                      https://ideogram.ai/api/images/ephemeral/WkoxvqiOTaaCqG1nO2tQoA.png?exp=1734370337&sig=110fe96dc9e01002c8d837e5b4cde1aaa266195561d231ce76e19e095e478ffe
          headers: {}
          x-apifox-name: 成功
      security: []
      x-apifox-folder: 绘画模型/Ideogram
      x-apifox-status: released
      x-run-in-apifox: https://app.apifox.com/web/project/8343734/apis/api-464684964-run
components:
  schemas: {}
  securitySchemes:
    bearer:
