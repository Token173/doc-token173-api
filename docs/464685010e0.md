...
paths:
  /volc/v1/contents/generations/tasks:
    post:
                  ...
                  content:
                    - type: text
                      text: >-
                        ...
                        --camera_fixed false --watermark false --seed 1
                summary: 文生视频
              '2':
                value:
              ...
              '3':
                value:
                  ...
                  content:
                    - type: text
                      text: >-
                        图中女孩对着镜头说“茄子”，360度环绕运镜 --resolution 1080p --ratio 16:9
                        --duration 12 --camera_fixed false --watermark false
                        --seed 1
                    - type: image_url
                      image_url:
                        url: >-
                  ...
                  content:
                    - type: text
                      text: >-
                        ...
                        --resolution 720p --ratio 16:9 --duration 12 --watermark
                        false --seed 1
                    - type: image_url
                      image_url:
                        url: >-
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/8343734/apis/api-464685010-run
components:
  schemas: {}
  securitySchemes:
    bearer:
