...
```json
{
  ...
  "models": {
    ...
    "providers": {
      ...
      "api-proxy-google": {
        "baseUrl": "https://Token173.com/v1beta",
...
#
:::info[]
按需选装 [API图片视频Skill](https://token173.apifox.cn/8863499m0.md) 方便OpenClaw执行图片视频生成编辑任务。
:::
